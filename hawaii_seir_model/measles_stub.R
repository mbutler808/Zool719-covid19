...
demog %>% subset(town==TOWN,select=-town) -> demogLondon
...
pfs1 <- m1 %>% pfilter(params=theta,Np=10000)
pfs2 <- m1 %>% pfilter(params=theta,Np=10000)
pfs3 <- m1 %>% pfilter(params=theta,Np=10000)
pfs4 <- m1 %>% pfilter(params=theta,Np=10000)
